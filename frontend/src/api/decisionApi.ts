...
export type EntityJob = { id: string; project_id: string; object_type_id: string; fields: string[]; status: string; candidate_count: number; objects_in_scope: number | null; objects_scanned: number | null; last_scanned_id: string | null; exact_objects?: number | null; exact_values_skipped?: number | null; exact_group_ceiling?: number; scan_order?: string; scan_limit?: number; candidates: EntityCandidate[] };
