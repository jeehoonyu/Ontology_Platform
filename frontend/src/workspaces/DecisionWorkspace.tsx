...
// "clear" only when the latest entity-resolution job compared this object and left no
// pending candidate. A job reads the first N objects by id, so an object past that, or
// made after it ran, was never compared, and "clear" said the opposite.
function duplicateStatus(explanation: DecisionExplanation | null): string {
  ...
  return explanation.duplicate_coverage?.compared ? "clear" : "not compared";
}
