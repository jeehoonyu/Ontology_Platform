...
| `components/data/DataGrid.tsx` | 201 | `DataGrid` | `allRows` (slice) | held as shown | no | yes |
| `components/data/DataGrid.tsx` | 197 | `DataGrid` | `total` (filtered row model) | filtered in the library | no | yes |
