...
try {
    ...
    $seedSql = "CREATE TABLE alembic_version(version_num varchar(64) primary key); INSERT INTO alembic_version VALUES ('0011_hashed_service_tokens'); CREATE TABLE recovery_probe(id integer primary key, value text); INSERT INTO recovery_probe VALUES (1, 'before-backup');"
