...
try {
    ...
    $seedSql = "CREATE TABLE alembic_version(version_num varchar(32) primary key); INSERT INTO alembic_version VALUES ('0021_project_operational_plane'); CREATE TABLE recovery_probe(id integer primary key, value text); INSERT INTO recovery_probe VALUES (1, 'before-backup');"
